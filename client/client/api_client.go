...
import (
	...
	"github.com/cycloidio/cycloid-cli/client/client/organization_plugin_managers"
	"github.com/cycloidio/cycloid-cli/client/client/organization_plugins"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *API {
	...
	cli.OrganizationPluginManagers = organization_plugin_managers.New(transport, formats)
	cli.OrganizationPlugins = organization_plugins.New(transport, formats)
...
type API struct {
	...
	OrganizationPluginManagers organization_plugin_managers.ClientService

	OrganizationPlugins organization_plugins.ClientService
...
func (c *API) SetTransport(transport runtime.ClientTransport) {
	...
	c.OrganizationPluginManagers.SetTransport(transport)
	c.OrganizationPlugins.SetTransport(transport)
