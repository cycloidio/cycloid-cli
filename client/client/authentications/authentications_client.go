...
// New creates a new authentications API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

// New creates a new authentications API client with basic auth credentials.
...
// New creates a new authentications API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
Client for authentications API
*/
type Client struct {
...
type ClientService interface {
	ListDefaultAuthentications(params *ListDefaultAuthenticationsParams, opts ...ClientOption) (*ListDefaultAuthenticationsOK, error)

	ListOrganizationDefaultAuthentications(params *ListOrganizationDefaultAuthenticationsParams, opts ...ClientOption) (*ListOrganizationDefaultAuthenticationsOK, error)
...
func (a *Client) ListDefaultAuthentications(params *ListDefaultAuthenticationsParams, opts ...ClientOption) (*ListDefaultAuthenticationsOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "listDefaultAuthentications",
		Method:             "GET",
		PathPattern:        "/authentications",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/vnd.cycloid.io.v1+json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ListDefaultAuthenticationsReader{formats: a.formats},
...
func (a *Client) ListOrganizationDefaultAuthentications(params *ListOrganizationDefaultAuthenticationsParams, opts ...ClientOption) (*ListOrganizationDefaultAuthenticationsOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "listOrganizationDefaultAuthentications",
		Method:             "GET",
		PathPattern:        "/authentications/{organization_canonical}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/vnd.cycloid.io.v1+json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ListOrganizationDefaultAuthenticationsReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
