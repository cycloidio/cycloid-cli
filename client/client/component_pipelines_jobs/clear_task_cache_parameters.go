...
// WithComponentCanonical adds the componentCanonical to the clear task cache params
func (o *ClearTaskCacheParams) WithComponentCanonical(componentCanonical string) *ClearTaskCacheParams {
	o.SetComponentCanonical(componentCanonical)
	return o
}

// SetComponentCanonical adds the componentCanonical to the clear task cache params
func (o *ClearTaskCacheParams) SetComponentCanonical(componentCanonical string) {
	o.ComponentCanonical = componentCanonical
}

// WithEnvironmentCanonical adds the environmentCanonical to the clear task cache params
func (o *ClearTaskCacheParams) WithEnvironmentCanonical(environmentCanonical string) *ClearTaskCacheParams {
	o.SetEnvironmentCanonical(environmentCanonical)
	return o
}

// SetEnvironmentCanonical adds the environmentCanonical to the clear task cache params
func (o *ClearTaskCacheParams) SetEnvironmentCanonical(environmentCanonical string) {
