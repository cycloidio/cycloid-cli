...
// WithComponentCanonical adds the componentCanonical to the get jobs params
func (o *GetJobsParams) WithComponentCanonical(componentCanonical string) *GetJobsParams {
	o.SetComponentCanonical(componentCanonical)
	return o
}

// SetComponentCanonical adds the componentCanonical to the get jobs params
func (o *GetJobsParams) SetComponentCanonical(componentCanonical string) {
	o.ComponentCanonical = componentCanonical
}

// WithEnvironmentCanonical adds the environmentCanonical to the get jobs params
func (o *GetJobsParams) WithEnvironmentCanonical(environmentCanonical string) *GetJobsParams {
	o.SetEnvironmentCanonical(environmentCanonical)
	return o
}

// SetEnvironmentCanonical adds the environmentCanonical to the get jobs params
func (o *GetJobsParams) SetEnvironmentCanonical(environmentCanonical string) {
