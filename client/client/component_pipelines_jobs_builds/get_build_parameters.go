...
// WithComponentCanonical adds the componentCanonical to the get build params
func (o *GetBuildParams) WithComponentCanonical(componentCanonical string) *GetBuildParams {
	o.SetComponentCanonical(componentCanonical)
	return o
}

// SetComponentCanonical adds the componentCanonical to the get build params
func (o *GetBuildParams) SetComponentCanonical(componentCanonical string) {
	o.ComponentCanonical = componentCanonical
}

// WithEnvironmentCanonical adds the environmentCanonical to the get build params
func (o *GetBuildParams) WithEnvironmentCanonical(environmentCanonical string) *GetBuildParams {
	o.SetEnvironmentCanonical(environmentCanonical)
	return o
}

// SetEnvironmentCanonical adds the environmentCanonical to the get build params
func (o *GetBuildParams) SetEnvironmentCanonical(environmentCanonical string) {
