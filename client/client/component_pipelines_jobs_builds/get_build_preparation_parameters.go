...
// WithComponentCanonical adds the componentCanonical to the get build preparation params
func (o *GetBuildPreparationParams) WithComponentCanonical(componentCanonical string) *GetBuildPreparationParams {
	o.SetComponentCanonical(componentCanonical)
	return o
}

// SetComponentCanonical adds the componentCanonical to the get build preparation params
func (o *GetBuildPreparationParams) SetComponentCanonical(componentCanonical string) {
	o.ComponentCanonical = componentCanonical
}

// WithEnvironmentCanonical adds the environmentCanonical to the get build preparation params
func (o *GetBuildPreparationParams) WithEnvironmentCanonical(environmentCanonical string) *GetBuildPreparationParams {
	o.SetEnvironmentCanonical(environmentCanonical)
	return o
}

// SetEnvironmentCanonical adds the environmentCanonical to the get build preparation params
func (o *GetBuildPreparationParams) SetEnvironmentCanonical(environmentCanonical string) {
