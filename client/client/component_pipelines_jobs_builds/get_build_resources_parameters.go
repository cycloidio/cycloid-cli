...
// WithComponentCanonical adds the componentCanonical to the get build resources params
func (o *GetBuildResourcesParams) WithComponentCanonical(componentCanonical string) *GetBuildResourcesParams {
	o.SetComponentCanonical(componentCanonical)
	return o
}

// SetComponentCanonical adds the componentCanonical to the get build resources params
func (o *GetBuildResourcesParams) SetComponentCanonical(componentCanonical string) {
	o.ComponentCanonical = componentCanonical
}

// WithEnvironmentCanonical adds the environmentCanonical to the get build resources params
func (o *GetBuildResourcesParams) WithEnvironmentCanonical(environmentCanonical string) *GetBuildResourcesParams {
	o.SetEnvironmentCanonical(environmentCanonical)
	return o
}

// SetEnvironmentCanonical adds the environmentCanonical to the get build resources params
func (o *GetBuildResourcesParams) SetEnvironmentCanonical(environmentCanonical string) {
