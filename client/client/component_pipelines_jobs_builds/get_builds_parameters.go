...
// WithComponentCanonical adds the componentCanonical to the get builds params
func (o *GetBuildsParams) WithComponentCanonical(componentCanonical string) *GetBuildsParams {
	o.SetComponentCanonical(componentCanonical)
	return o
}

// SetComponentCanonical adds the componentCanonical to the get builds params
func (o *GetBuildsParams) SetComponentCanonical(componentCanonical string) {
...
// WithEnvironmentCanonical adds the environmentCanonical to the get builds params
func (o *GetBuildsParams) WithEnvironmentCanonical(environmentCanonical string) *GetBuildsParams {
	o.SetEnvironmentCanonical(environmentCanonical)
	return o
}

// SetEnvironmentCanonical adds the environmentCanonical to the get builds params
func (o *GetBuildsParams) SetEnvironmentCanonical(environmentCanonical string) {
