...
CostEstimateFormsParams contains all the parameters to send to the API endpoint
	...
	for the cost estimate forms operation.
...
// WithDefaults hydrates default values in the cost estimate forms params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CostEstimateFormsParams) WithDefaults() *CostEstimateFormsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cost estimate forms params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CostEstimateFormsParams) SetDefaults() {
