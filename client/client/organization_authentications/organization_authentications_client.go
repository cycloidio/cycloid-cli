...
// New creates a new organization authentications API client with basic auth credentials.
...
// New creates a new organization authentications API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
func (a *Client) GetAuthentication(params *GetAuthenticationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAuthenticationOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/organizations/{organization_canonical}/authentications/{authentication_type}",
...
func (a *Client) ListAuthentications(params *ListAuthenticationsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListAuthenticationsOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/organizations/{organization_canonical}/authentications",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/vnd.cycloid.io.v1+json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ListAuthenticationsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
...
func (a *Client) UpdateAuthentication(params *UpdateAuthenticationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateAuthenticationOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateAuthenticationReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
