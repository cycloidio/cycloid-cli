...
// New creates a new organization cloud cost management API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

// New creates a new organization cloud cost management API client with basic auth credentials.
...
// New creates a new organization cloud cost management API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
Client for organization cloud cost management API
*/
type Client struct {
...
type ClientService interface {
	GetCloudCostManagementTags(params *GetCloudCostManagementTagsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCloudCostManagementTagsOK, error)
...
func (a *Client) GetCloudCostManagementTags(params *GetCloudCostManagementTagsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCloudCostManagementTagsOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "getCloudCostManagementTags",
		Method:             "GET",
		PathPattern:        "/organizations/{organization_canonical}/cloud_cost_management/tags",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/vnd.cycloid.io.v1+json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetCloudCostManagementTagsReader{formats: a.formats},
		AuthInfo:           authInfo,
