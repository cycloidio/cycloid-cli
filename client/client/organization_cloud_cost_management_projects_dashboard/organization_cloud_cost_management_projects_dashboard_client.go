...
// New creates a new organization cloud cost management projects dashboard API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

// New creates a new organization cloud cost management projects dashboard API client with basic auth credentials.
...
// New creates a new organization cloud cost management projects dashboard API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
Client for organization cloud cost management projects dashboard API
*/
type Client struct {
...
type ClientService interface {
	GetCloudCostManagementProjectsDashboard(params *GetCloudCostManagementProjectsDashboardParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCloudCostManagementProjectsDashboardOK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
	GetCloudCostManagementProjectsDashboard Return the projects dashboard of the Cloud Cost Management.
...
func (a *Client) GetCloudCostManagementProjectsDashboard(params *GetCloudCostManagementProjectsDashboardParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCloudCostManagementProjectsDashboardOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "getCloudCostManagementProjectsDashboard",
		Method:             "GET",
		PathPattern:        "/organizations/{organization_canonical}/cloud_cost_management/projects",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/vnd.cycloid.io.v1+json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetCloudCostManagementProjectsDashboardReader{formats: a.formats},
		AuthInfo:           authInfo,
