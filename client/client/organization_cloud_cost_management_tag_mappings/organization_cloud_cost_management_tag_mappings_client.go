...
// New creates a new organization cloud cost management tag mappings API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

// New creates a new organization cloud cost management tag mappings API client with basic auth credentials.
...
// New creates a new organization cloud cost management tag mappings API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
Client for organization cloud cost management tag mappings API
*/
type Client struct {
...
type ClientService interface {
	GetCloudCostManagementTagMapping(params *GetCloudCostManagementTagMappingParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCloudCostManagementTagMappingOK, error)

	PutCloudCostManagementTagMapping(params *PutCloudCostManagementTagMappingParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PutCloudCostManagementTagMappingOK, error)
...
func (a *Client) GetCloudCostManagementTagMapping(params *GetCloudCostManagementTagMappingParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCloudCostManagementTagMappingOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "getCloudCostManagementTagMapping",
		Method:             "GET",
		PathPattern:        "/organizations/{organization_canonical}/cloud_cost_management/tag_mapping",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/vnd.cycloid.io.v1+json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetCloudCostManagementTagMappingReader{formats: a.formats},
		AuthInfo:           authInfo,
...
func (a *Client) PutCloudCostManagementTagMapping(params *PutCloudCostManagementTagMappingParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PutCloudCostManagementTagMappingOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "putCloudCostManagementTagMapping",
		Method:             "PUT",
		PathPattern:        "/organizations/{organization_canonical}/cloud_cost_management/tag_mapping",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/vnd.cycloid.io.v1+json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &PutCloudCostManagementTagMappingReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
