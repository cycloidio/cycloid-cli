...
// WithIgnoreConfigFilesErr adds the ignoreConfigFilesErr to the delete component params
func (o *DeleteComponentParams) WithIgnoreConfigFilesErr(ignoreConfigFilesErr *bool) *DeleteComponentParams {
	o.SetIgnoreConfigFilesErr(ignoreConfigFilesErr)
	return o
}

// SetIgnoreConfigFilesErr adds the ignoreConfigFilesErr to the delete component params
func (o *DeleteComponentParams) SetIgnoreConfigFilesErr(ignoreConfigFilesErr *bool) {
