...
// WithServiceCatalogSourceVersionID adds the serviceCatalogSourceVersionID to the get component config params
func (o *GetComponentConfigParams) WithServiceCatalogSourceVersionID(serviceCatalogSourceVersionID *uint32) *GetComponentConfigParams {
	o.SetServiceCatalogSourceVersionID(serviceCatalogSourceVersionID)
	return o
}

// SetServiceCatalogSourceVersionID adds the serviceCatalogSourceVersionId to the get component config params
func (o *GetComponentConfigParams) SetServiceCatalogSourceVersionID(serviceCatalogSourceVersionID *uint32) {
