...
// WithPageIndex adds the pageIndex to the get components params
func (o *GetComponentsParams) WithPageIndex(pageIndex *uint32) *GetComponentsParams {
	o.SetPageIndex(pageIndex)
	return o
}

// SetPageIndex adds the pageIndex to the get components params
func (o *GetComponentsParams) SetPageIndex(pageIndex *uint32) {
	o.PageIndex = pageIndex
}

// WithPageSize adds the pageSize to the get components params
func (o *GetComponentsParams) WithPageSize(pageSize *uint32) *GetComponentsParams {
	o.SetPageSize(pageSize)
	return o
}

// SetPageSize adds the pageSize to the get components params
func (o *GetComponentsParams) SetPageSize(pageSize *uint32) {
	o.PageSize = pageSize
}
