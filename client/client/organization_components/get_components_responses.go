...
func (o *GetComponentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetComponentsOKBody) validatePagination(formats strfmt.Registry) error {

	if err := validate.Required("getComponentsOK"+"."+"pagination", "body", o.Pagination); err != nil {
		return err
	}
	...
	if o.Pagination != nil {
		if err := o.Pagination.Validate(formats); err != nil {
			ve := new(errors.Validation)
			if stderrors.As(err, &ve) {
				return ve.ValidateName("getComponentsOK" + "." + "pagination")
			}
			ce := new(errors.CompositeError)
			if stderrors.As(err, &ce) {
				return ce.ValidateName("getComponentsOK" + "." + "pagination")
			}
...
func (o *GetComponentsOKBody) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
