...
func (o *GetOrganizationComponentsOKBody) validatePagination(formats strfmt.Registry) error {

	if err := validate.Required("getOrganizationComponentsOK"+"."+"pagination", "body", o.Pagination); err != nil {
		return err
	}
	...
	if o.Pagination != nil {
		if err := o.Pagination.Validate(formats); err != nil {
			ve := new(errors.Validation)
			if stderrors.As(err, &ve) {
				return ve.ValidateName("getOrganizationComponentsOK" + "." + "pagination")
			}
			ce := new(errors.CompositeError)
			if stderrors.As(err, &ce) {
				return ce.ValidateName("getOrganizationComponentsOK" + "." + "pagination")
			}
...
func (o *GetOrganizationComponentsOKBody) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
