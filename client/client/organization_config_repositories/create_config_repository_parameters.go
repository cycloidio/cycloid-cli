...
CreateConfigRepositoryParams contains all the parameters to send to the API endpoint
	...
	for the create config repository operation.
...
// WithDefaults hydrates default values in the create config repository params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateConfigRepositoryParams) WithDefaults() *CreateConfigRepositoryParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create config repository params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateConfigRepositoryParams) SetDefaults() {
