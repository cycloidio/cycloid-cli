...
// New creates a new organization environments API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

// New creates a new organization environments API client with basic auth credentials.
...
// New creates a new organization environments API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
Client for organization environments API
*/
type Client struct {
...
type ClientService interface {
	GetOrganizationEnvironments(params *GetOrganizationEnvironmentsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetOrganizationEnvironmentsOK, error)
...
func (a *Client) GetOrganizationEnvironments(params *GetOrganizationEnvironmentsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetOrganizationEnvironmentsOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "getOrganizationEnvironments",
		Method:             "GET",
		PathPattern:        "/organizations/{organization_canonical}/environments",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/vnd.cycloid.io.v1+json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetOrganizationEnvironmentsReader{formats: a.formats},
		AuthInfo:           authInfo,
