...
GetExternalBackendParams contains all the parameters to send to the API endpoint
	...
	for the get external backend operation.
...
// WithDefaults hydrates default values in the get external backend params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetExternalBackendParams) WithDefaults() *GetExternalBackendParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get external backend params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetExternalBackendParams) SetDefaults() {
