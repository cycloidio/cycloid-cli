...
GetInfraPolicyParams contains all the parameters to send to the API endpoint
	...
	for the get infra policy operation.
...
// WithDefaults hydrates default values in the get infra policy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetInfraPolicyParams) WithDefaults() *GetInfraPolicyParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get infra policy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetInfraPolicyParams) SetDefaults() {
