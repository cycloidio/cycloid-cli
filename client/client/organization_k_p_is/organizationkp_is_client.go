...
// New creates a new organization k p is API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

// New creates a new organization k p is API client with basic auth credentials.
...
// New creates a new organization k p is API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
Client for organization k p is API
*/
type Client struct {
...
type ClientService interface {
	GetOrganizationKpis(params *GetOrganizationKpisParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetOrganizationKpisOK, error)
...
func (a *Client) GetOrganizationKpis(params *GetOrganizationKpisParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetOrganizationKpisOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Params:             params,
		Reader:             &GetOrganizationKpisReader{formats: a.formats},
		AuthInfo:           authInfo,
