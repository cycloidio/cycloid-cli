...
type DeleteEnvironmentParams struct {
	...
	*/
	...
	/* IgnoreConfigFilesErr.

	   Defines if the error in config files operation (such as their removal) will be ignored instead of throwing an error and stopping the request
	*/
...
// WithIgnoreConfigFilesErr adds the ignoreConfigFilesErr to the delete environment params
func (o *DeleteEnvironmentParams) WithIgnoreConfigFilesErr(ignoreConfigFilesErr *bool) *DeleteEnvironmentParams {
	o.SetIgnoreConfigFilesErr(ignoreConfigFilesErr)
	return o
}

// SetIgnoreConfigFilesErr adds the ignoreConfigFilesErr to the delete environment params
func (o *DeleteEnvironmentParams) SetIgnoreConfigFilesErr(ignoreConfigFilesErr *bool) {
	o.IgnoreConfigFilesErr = ignoreConfigFilesErr
}
...
func (o *DeleteEnvironmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IgnoreConfigFilesErr != nil {

		// query param ignore_config_files_err
		var qrIgnoreConfigFilesErr bool

		if o.IgnoreConfigFilesErr != nil {
			qrIgnoreConfigFilesErr = *o.IgnoreConfigFilesErr
		}
		qIgnoreConfigFilesErr := swag.FormatBool(qrIgnoreConfigFilesErr)
		if qIgnoreConfigFilesErr != "" {

			if err := r.SetQueryParam("ignore_config_files_err", qIgnoreConfigFilesErr); err != nil {
				return err
			}
		}
	}
