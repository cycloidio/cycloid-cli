...
// WithIgnoreConfigFilesErr adds the ignoreConfigFilesErr to the delete project params
func (o *DeleteProjectParams) WithIgnoreConfigFilesErr(ignoreConfigFilesErr *bool) *DeleteProjectParams {
	o.SetIgnoreConfigFilesErr(ignoreConfigFilesErr)
	return o
}

// SetIgnoreConfigFilesErr adds the ignoreConfigFilesErr to the delete project params
func (o *DeleteProjectParams) SetIgnoreConfigFilesErr(ignoreConfigFilesErr *bool) {
