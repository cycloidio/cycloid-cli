...
func (o *CreateRoleParams) WithBody(body *models.NewRole) *CreateRoleParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create role params
func (o *CreateRoleParams) SetBody(body *models.NewRole) {
	o.Body = body
}

// WithOrganizationCanonical adds the organizationCanonical to the create role params
func (o *CreateRoleParams) WithOrganizationCanonical(organizationCanonical string) *CreateRoleParams {
	o.SetOrganizationCanonical(organizationCanonical)
	return o
}

// SetOrganizationCanonical adds the organizationCanonical to the create role params
func (o *CreateRoleParams) SetOrganizationCanonical(organizationCanonical string) {
