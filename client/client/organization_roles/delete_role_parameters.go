...
// WithOrganizationCanonical adds the organizationCanonical to the delete role params
func (o *DeleteRoleParams) WithOrganizationCanonical(organizationCanonical string) *DeleteRoleParams {
	o.SetOrganizationCanonical(organizationCanonical)
	return o
}

// SetOrganizationCanonical adds the organizationCanonical to the delete role params
func (o *DeleteRoleParams) SetOrganizationCanonical(organizationCanonical string) {
	o.OrganizationCanonical = organizationCanonical
}

// WithRoleCanonical adds the roleCanonical to the delete role params
func (o *DeleteRoleParams) WithRoleCanonical(roleCanonical string) *DeleteRoleParams {
	o.SetRoleCanonical(roleCanonical)
	return o
}

// SetRoleCanonical adds the roleCanonical to the delete role params
func (o *DeleteRoleParams) SetRoleCanonical(roleCanonical string) {
