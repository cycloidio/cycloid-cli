...
// WithOrganizationCanonical adds the organizationCanonical to the get role params
func (o *GetRoleParams) WithOrganizationCanonical(organizationCanonical string) *GetRoleParams {
	o.SetOrganizationCanonical(organizationCanonical)
	return o
}

// SetOrganizationCanonical adds the organizationCanonical to the get role params
func (o *GetRoleParams) SetOrganizationCanonical(organizationCanonical string) {
	o.OrganizationCanonical = organizationCanonical
}

// WithRoleCanonical adds the roleCanonical to the get role params
func (o *GetRoleParams) WithRoleCanonical(roleCanonical string) *GetRoleParams {
	o.SetRoleCanonical(roleCanonical)
	return o
}

// SetRoleCanonical adds the roleCanonical to the get role params
func (o *GetRoleParams) SetRoleCanonical(roleCanonical string) {
