...
GetServiceCatalogSourceParams contains all the parameters to send to the API endpoint
	...
	for the get service catalog source operation.
...
// WithDefaults hydrates default values in the get service catalog source params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetServiceCatalogSourceParams) WithDefaults() *GetServiceCatalogSourceParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get service catalog source params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetServiceCatalogSourceParams) SetDefaults() {
	var (
	...
	val := GetServiceCatalogSourceParams{
