...
GetServiceCatalogSourcesParams contains all the parameters to send to the API endpoint
	...
	for the get service catalog sources operation.
...
// WithDefaults hydrates default values in the get service catalog sources params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetServiceCatalogSourcesParams) WithDefaults() *GetServiceCatalogSourcesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get service catalog sources params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetServiceCatalogSourcesParams) SetDefaults() {
	var (
	...
	val := GetServiceCatalogSourcesParams{
