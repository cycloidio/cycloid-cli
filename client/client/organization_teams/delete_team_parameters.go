...
// WithOrganizationCanonical adds the organizationCanonical to the delete team params
func (o *DeleteTeamParams) WithOrganizationCanonical(organizationCanonical string) *DeleteTeamParams {
	o.SetOrganizationCanonical(organizationCanonical)
	return o
}

// SetOrganizationCanonical adds the organizationCanonical to the delete team params
func (o *DeleteTeamParams) SetOrganizationCanonical(organizationCanonical string) {
	o.OrganizationCanonical = organizationCanonical
}

// WithTeamCanonical adds the teamCanonical to the delete team params
func (o *DeleteTeamParams) WithTeamCanonical(teamCanonical string) *DeleteTeamParams {
	o.SetTeamCanonical(teamCanonical)
	return o
}

// SetTeamCanonical adds the teamCanonical to the delete team params
func (o *DeleteTeamParams) SetTeamCanonical(teamCanonical string) {
