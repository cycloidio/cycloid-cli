...
// WithDefaults hydrates default values in the can do params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CanDoParams) WithDefaults() *CanDoParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the can do params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CanDoParams) SetDefaults() {
