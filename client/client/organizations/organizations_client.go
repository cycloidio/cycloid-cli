...
type ClientService interface {
	...
	GetOrganizationMessages(params *GetOrganizationMessagesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetOrganizationMessagesOK, error)
	...
	UpdateOrganizationMessages(params *UpdateOrganizationMessagesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateOrganizationMessagesOK, error)
...
/*
GetOrganizationMessages gets the organization messages

Returns the messages associated to the organization.
*/
func (a *Client) GetOrganizationMessages(params *GetOrganizationMessagesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetOrganizationMessagesOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetOrganizationMessagesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getOrganizationMessages",
		Method:             "GET",
		PathPattern:        "/organizations/{organization_canonical}/messages",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/vnd.cycloid.io.v1+json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetOrganizationMessagesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetOrganizationMessagesOK)
	if ok {
		return success, nil
	}
	...
	//
	// a default response is provided: fill this and return an error
	unexpectedSuccess := result.(*GetOrganizationMessagesDefault)
...
/*
UpdateOrganizationMessages updates the organization messages

Updates the messages associated to the organization.
*/
func (a *Client) UpdateOrganizationMessages(params *UpdateOrganizationMessagesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateOrganizationMessagesOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewUpdateOrganizationMessagesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "updateOrganizationMessages",
		Method:             "PUT",
		PathPattern:        "/organizations/{organization_canonical}/messages",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/vnd.cycloid.io.v1+json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateOrganizationMessagesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*UpdateOrganizationMessagesOK)
	if ok {
		return success, nil
	}
	...
	//
	// a default response is provided: fill this and return an error
	unexpectedSuccess := result.(*UpdateOrganizationMessagesDefault)
