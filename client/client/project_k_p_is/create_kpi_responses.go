...
func (o *CreateKpiReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateKpiOK) Error() string {
	...
	return fmt.Sprintf("[POST /organizations/{organization_canonical}/projects/{project_canonical}/kpis][%d] createKpiOK %s", 200, payload)
}
...
func (o *CreateKpiForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /organizations/{organization_canonical}/projects/{project_canonical}/kpis][%d] createKpiForbidden %s", 403, payload)
}
...
func (o *CreateKpiUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /organizations/{organization_canonical}/projects/{project_canonical}/kpis][%d] createKpiUnprocessableEntity %s", 422, payload)
}
...
func (o *CreateKpiDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /organizations/{organization_canonical}/projects/{project_canonical}/kpis][%d] createKpi default %s", o._statusCode, payload)
}
