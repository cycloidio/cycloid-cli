...
func (o *UpdateKpiReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UpdateKpiOK) Error() string {
	...
	return fmt.Sprintf("[PUT /organizations/{organization_canonical}/projects/{project_canonical}/kpis/{kpi_canonical}][%d] updateKpiOK %s", 200, payload)
}
...
func (o *UpdateKpiForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /organizations/{organization_canonical}/projects/{project_canonical}/kpis/{kpi_canonical}][%d] updateKpiForbidden %s", 403, payload)
}
...
func (o *UpdateKpiNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /organizations/{organization_canonical}/projects/{project_canonical}/kpis/{kpi_canonical}][%d] updateKpiNotFound %s", 404, payload)
}
...
func (o *UpdateKpiLengthRequired) Error() string {
	return fmt.Sprintf("[PUT /organizations/{organization_canonical}/projects/{project_canonical}/kpis/{kpi_canonical}][%d] updateKpiLengthRequired", 411)
}
...
func (o *UpdateKpiUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /organizations/{organization_canonical}/projects/{project_canonical}/kpis/{kpi_canonical}][%d] updateKpiUnprocessableEntity %s", 422, payload)
}
...
func (o *UpdateKpiDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /organizations/{organization_canonical}/projects/{project_canonical}/kpis/{kpi_canonical}][%d] updateKpi default %s", o._statusCode, payload)
}
