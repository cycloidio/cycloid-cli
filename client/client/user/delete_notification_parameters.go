...
func (o *DeleteNotificationParams) WithNotificationID(notificationID uint32) *DeleteNotificationParams {
	o.SetNotificationID(notificationID)
	return o
}

// SetNotificationID adds the notificationId to the delete notification params
func (o *DeleteNotificationParams) SetNotificationID(notificationID uint32) {
