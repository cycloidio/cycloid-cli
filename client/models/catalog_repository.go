...
// swagger:model CatalogRepository
type CatalogRepository struct {
	...
	Changes *StackChanges `json:"changes,omitempty"`
...
// Validate validates this catalog repository
func (m *CatalogRepository) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CatalogRepository) validateCanonical(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateChanges(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateCredentialCanonical(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateID(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateName(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateOwner(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateRefreshedAt(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateStackCount(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateStacks(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *CatalogRepository) validateURL(formats strfmt.Registry) error {
...
func (m *CatalogRepository) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CatalogRepository) UnmarshalBinary(b []byte) error {
	var res CatalogRepository
