...
func (m *MemberOrg) validateInvitationResentAt(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("invitation_resent_at", "body", int64(*m.InvitationResentAt), 0, false); err != nil {
		return err
	}
...
func (m *MemberOrg) validateInvitationStateEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, memberOrgTypeInvitationStatePropEnum); err != nil {
		return err
	}
	return nil
}
