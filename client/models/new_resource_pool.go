...
// ContextValidate validates this new resource pool based on context it is used
func (m *NewResourcePool) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
