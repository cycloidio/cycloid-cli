...
// ContextValidate validate this state resource based on the context it is used
func (m *StateResource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StateResource) contextValidateInstances(ctx context.Context, formats strfmt.Registry) error {
