...
// ContextValidate validate this task config based on the context it is used
func (m *TaskConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TaskConfig) contextValidateInputs(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaskConfig) contextValidateRun(ctx context.Context, formats strfmt.Registry) error {
