...
// UpdateCatalogRepository UpdateCatalogRepository
// swagger:model UpdateCatalogRepository
type UpdateCatalogRepository struct {
...
// Validate validates this update catalog repository
func (m *UpdateCatalogRepository) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateCatalogRepository) validateCredentialCanonical(formats strfmt.Registry) error {
...
func (m *UpdateCatalogRepository) validateName(formats strfmt.Registry) error {
...
func (m *UpdateCatalogRepository) validateURL(formats strfmt.Registry) error {
...
func (m *UpdateCatalogRepository) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateCatalogRepository) UnmarshalBinary(b []byte) error {
	var res UpdateCatalogRepository
