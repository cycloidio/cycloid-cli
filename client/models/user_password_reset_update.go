...
func (m *UserPasswordResetUpdate) validatePassword(formats strfmt.Registry) error {
...
func (m *UserPasswordResetUpdate) validateToken(formats strfmt.Registry) error {
...
func (m *UserPasswordResetUpdate) UnmarshalBinary(b []byte) error {
	var res UserPasswordResetUpdate
