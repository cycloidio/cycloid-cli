...
type APIClient interface {
	...
	UpdateCatalogRepository(org, catalogRepo, name, url, branch, cred string, visibility *string) (*models.ServiceCatalogSource, *http.Response, error)
	...
	ListTeamMembers(org, team string, filters ...LHSFilter) ([]*models.MemberTeam, *http.Response, error)
	GetTeamMember(org, team string, memberID uint32) (*models.MemberTeam, *http.Response, error)
	...
	UpdateOrganization(org, name string, opts ...UpdateOrganizationOpts) (*models.Organization, *http.Response, error)
	...
	GetProject(org, project string) (*models.Project, *http.Response, error)
...
func NewAPIClient(api *common.APIClient) APIClient {
