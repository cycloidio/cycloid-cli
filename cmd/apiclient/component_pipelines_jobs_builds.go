...
func (m *apiClient) GetBuilds(org, project, env, component, pipeline, job string) ([]*models.Build, *http.Response, error) {
...
func (m *apiClient) GetBuild(org, project, env, component, pipeline, job, buildID string) (*models.Build, *http.Response, error) {
	var result *models.Build
	resp, err := m.GenericRequest(Request{
		Method:       "GET",
		Organization: &org,
...
func (m *apiClient) CreateBuild(org, project, env, component, pipeline, job string) (*models.Build, *http.Response, error) {
	var result *models.Build
	resp, err := m.GenericRequest(Request{
		Method:       "POST",
		Organization: &org,
...
func (m *apiClient) RerunBuild(org, project, env, component, pipeline, job, buildID string) (*models.Build, *http.Response, error) {
	var result *models.Build
	resp, err := m.GenericRequest(Request{
		Method:       "POST",
		Organization: &org,
...
func (m *apiClient) AbortBuild(org, project, env, component, pipeline, job, buildID string) (*http.Response, error) {
	resp, err := m.GenericRequest(Request{
		Method:       "PUT",
		Organization: &org,
...
func (m *apiClient) GetBuildEvents(org, project, env, component, pipeline, buildID string) (*string, *http.Response, error) {
...
func (m *apiClient) OpenBuildEventsStream(
	ctx context.Context,
...
func (m *apiClient) GetBuildPlan(org, project, env, component, pipeline, job, buildID string) (*models.PublicPlan, *http.Response, error) {
...
func (m *apiClient) GetBuildPreparation(org, project, env, component, pipeline, job, buildID string) (*models.Preparation, *http.Response, error) {
...
func (m *apiClient) GetBuildResources(org, project, env, component, pipeline, job, buildID string) (*models.BuildInputsOutputs, *http.Response, error) {
