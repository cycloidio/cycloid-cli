...
func (m *apiClient) SendEvent(org, eventType, title, message, severity string, tags map[string]string, color string) (*http.Response, error) {
	var ts []*models.Tag
...
func (m *apiClient) ListEvents(org string, eventType, eventSeverity []string, begin, end uint64) ([]*models.Event, *http.Response, error) {
	query := url.Values{}
