...
func (m *apiClient) GetRemoteTFExternalBackend(org string) (*models.ExternalBackend, error) {
...
func (m *apiClient) GetExternalBackend(org string, externalBackend uint32) (*models.ExternalBackend, *http.Response, error) {
...
func (m *apiClient) ListExternalBackends(org string) ([]*models.ExternalBackend, *http.Response, error) {
	var result []*models.ExternalBackend
	resp, err := m.GenericRequest(Request{
		Method:       "GET",
		Organization: &org,
...
func (m *apiClient) CreateExternalBackends(org, project, env, purpose, credential string, isDefault bool, ebConfig models.ExternalBackendConfiguration) (*models.ExternalBackend, *http.Response, error) {
...
func (m *apiClient) UpdateExternalBackend(org string, externalBackendID uint32, purpose, credential string, isDefault bool, ebConfig models.ExternalBackendConfiguration) (*models.ExternalBackend, *http.Response, error) {
