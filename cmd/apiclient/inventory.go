...
func (m *apiClient) ListInventoryResources(org string, filters ...LHSFilter) ([]*models.InventoryResource, *http.Response, error) {
...
func (m *apiClient) ListInventoryOutputs(org string, filters ...LHSFilter) ([]*InventoryOutput, *http.Response, error) {
...
func (m *apiClient) CreateInventoryResource(org string, body *models.NewInventoryResource) (*models.InventoryResource, *http.Response, error) {
	var result *models.InventoryResource
	resp, err := m.GenericRequest(Request{
		Method:       "POST",
		Organization: &org,
...
func (m *apiClient) DeleteInventoryResource(org string, id uint32) (*http.Response, error) {
	resp, err := m.GenericRequest(Request{
		Method:       "DELETE",
		Organization: &org,
