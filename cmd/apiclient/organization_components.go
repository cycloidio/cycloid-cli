...
func (m *apiClient) ListComponents(org, project, env string, filters ...LHSFilter) ([]*models.Component, *http.Response, error) {
	var result []*models.Component
	resp, err := m.GenericRequest(Request{
		Method:       "GET",
		Organization: &org,
...
func (m *apiClient) CreateOrUpdateComponent(org, project, env, component, description, name, stackRef, versionTag, versionBranch, versionCommitHash, useCase, cloudProvider string, vars models.FormVariables) (*models.Component, *http.Response, error) {
...
func (m *apiClient) MigrateComponent(org, project, env, component, targetProject, targetEnv, newCanonical, newName string) (*models.Component, *http.Response, error) {
...
func (m *apiClient) DeleteComponent(org, project, env, component string, opts DeleteOptions) (*http.Response, error) {
	req := Request{
		Method:       "DELETE",
		Organization: &org,
		Route:        []string{"organizations", org, "projects", project, "environments", env, "components", component},
