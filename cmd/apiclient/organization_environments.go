...
func (m *apiClient) ListOrgEnvs(org string, filters ...LHSFilter) ([]*models.Environment, *http.Response, error) {
...
func (m *apiClient) GetOrgEnv(org, env string) (*models.Environment, *http.Response, error) {
...
func (m *apiClient) CreateOrgEnv(org string, body *models.NewEnvironment) (*models.Environment, *http.Response, error) {
	var result *models.Environment
	resp, err := m.GenericRequest(Request{
		Method:       "POST",
		Organization: &org,
...
func (m *apiClient) UpdateOrgEnv(org, env string, body *models.UpdateEnvironment) (*models.Environment, *http.Response, error) {
	var result *models.Environment
	resp, err := m.GenericRequest(Request{
		Method:       "PUT",
		Organization: &org,
...
func (m *apiClient) DeleteOrgEnv(org, env string) (*http.Response, error) {
...
func (m *apiClient) LinkEnvToProject(org, project, env string) (*http.Response, error) {
...
func (m *apiClient) UnlinkEnvFromProject(org, project, env string, opts DeleteOptions) (*http.Response, error) {
	req := Request{
		Method:       "DELETE",
		Organization: &org,
