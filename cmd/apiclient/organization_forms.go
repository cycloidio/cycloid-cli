...
func (m *apiClient) ValidateForm(org string, rawForms []byte) (*models.FormsValidationResult, *http.Response, error) {
	var formsfile any
...
func (m *apiClient) InterpolateFormsConfig(org, project, env, component, serviceCatalogRef, useCase string, inputs models.FormVariables) (*models.ServiceCatalogConfig, *http.Response, error) {
	if inputs == nil {
