...
//
// This type lives in the apiClient package (not client/models) following the
...
func (m *apiClient) GetOrgNav(org string) (*NavConfig, *http.Response, error) {
...
func (m *apiClient) UpdateOrgNav(org string, items []*NavItem) (*NavConfig, *http.Response, error) {
