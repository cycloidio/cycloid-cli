...
var AvailableSubscriptionPlans = []string{
	FreeTrial,
	PlatformTeam,
}
...
func (m *apiClient) CreateOrUpdateSubscription(org string, plan SubscriptionPlan, expiresAt time.Time, membersCount uint64, overwrite bool) (*models.Subscription, *http.Response, error) {
