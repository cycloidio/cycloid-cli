...
func (m *middleware) ListTeamMembers(org, team string, filters ...LHSFilter) ([]*models.MemberTeam, *http.Response, error) {
...
func (m *middleware) GetTeamMember(org, team string, memberID uint32) (*models.MemberTeam, *http.Response, error) {
	var result *models.MemberTeam
	resp, err := m.GenericRequest(Request{
		Method:       "GET",
		Organization: &org,
