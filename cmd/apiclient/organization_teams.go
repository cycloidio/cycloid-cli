...
func (m *apiClient) ListTeams(org string, teamNameFilter *string, createdAtFilter *uint64, memberIDFilter *uint32, orderBy *TeamOrderByParam, filters ...LHSFilter) ([]*models.Team, *http.Response, error) {
	query := url.Values{}
...
func (m *apiClient) GetTeam(org, team string) (*models.Team, *http.Response, error) {
	var result *models.Team
	resp, err := m.GenericRequest(Request{
		Method:       "GET",
		Organization: &org,
...
func (m *apiClient) CreateTeam(org string, name, team, owner *string, roles []string) (*models.Team, *http.Response, error) {
...
func (m *apiClient) UpdateTeam(org string, name, team, owner *string, roles []string) (*models.Team, *http.Response, error) {
	teamName, canonical, err := NameOrCanonical(name, team)
	if err != nil {
		return nil, nil, err
	}
...
func (m *apiClient) DeleteTeam(org, team string) (*http.Response, error) {
	resp, err := m.GenericRequest(Request{
		Method:       "DELETE",
		Organization: &org,
		Route:        []string{"organizations", org, "teams", team},
