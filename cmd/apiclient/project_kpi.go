...
// )
//
// func (m *apiClient) CreateKpi(name, kpiType, widget, org, project, job, env, config string) (*models.KPI, error) {
...
// }
//
// func (m *apiClient) ListKpi(org, project, env string) ([]*models.KPI, error) {
...
// }
//
// func (m *apiClient) DeleteKpi(org, kpi string) error {
