...
func (m *apiClient) GetStack(org, ref string) (*models.ServiceCatalog, *http.Response, error) {
...
func (m *apiClient) ListStacks(org string, filters ...LHSFilter) ([]*models.ServiceCatalog, *http.Response, error) {
	var result []*models.ServiceCatalog
	resp, err := m.GenericRequest(Request{
		Method:       "GET",
		Organization: &org,
...
func (m *apiClient) resolveStackVersion(org, stackRef, versionTag, versionBranch, versionCommitHash string) (versionID uint32, commitHash string, err error) {
...
func (m *apiClient) ListStackUseCases(org, ref, versionTag, versionBranch, versionCommitHash string, filters ...LHSFilter) ([]*StackUseCase, *http.Response, error) {
...
// NOTE: the backend handler for this route does not call lhs.ParseQuery, so
// LHS filters are accepted by the apiClient but silently ignored server-side.
func (m *apiClient) ListStackVersions(org, ref string, filters ...LHSFilter) ([]*StackVersion, *http.Response, error) {
...
func (m *apiClient) ResolveStackVersion(org, ref, stackVersion string) (uint32, string, error) {
...
func (m *apiClient) getDefaultCatalogVersion(org, ref string) (*StackVersion, error) {
...
func (m *apiClient) ListBlueprints(org string, filters ...LHSFilter) ([]*models.ServiceCatalog, *http.Response, error) {
	lhsFilters := append(
...
func (m *apiClient) CreateStackFromBlueprint(org, blueprintRef, name, stack, catalogRepository, useCase string) (*models.ServiceCatalog, *http.Response, error) {
