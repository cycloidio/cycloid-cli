...
func (m *apiClient) UserSignup(username, email, password, fullName string) (*http.Response, error) {
...
func (m *apiClient) RefreshToken(org, childOrg *string, token string) (*models.UserSession, *http.Response, error) {
	query := url.Values{}
	if org != nil {
...
func (m *apiClient) UserLogin(org, email *string, password string) (*models.UserSession, *http.Response, error) {
...
func (m *apiClient) UserLoginToOrg(org, email, password string) (*models.UserSession, *http.Response, error) {
	emailFmt := strfmt.Email(email)
	body := models.UserLogin{
		Email:                 &emailFmt,
