...
func NewRelationSetCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short:             "[beta] Enable or disable a plugin for a component",
		Example: `
  cy beta plugin component relation-set my-plugin --project my-project --env production --component my-component --enabled
  cy beta plugin component relation-set 42 --project my-project --env production --component my-component --no-enabled
`,
