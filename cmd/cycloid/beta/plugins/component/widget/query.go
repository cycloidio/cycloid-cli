...
func NewQueryCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "[beta] Query data for a component-level plugin widget",
		Example: `
  cy beta plugin component widget query 42 --project my-project --env production --component my-component
`,
