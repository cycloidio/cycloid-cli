...
func NewRetryCommand() *cobra.Command {
	return &cobra.Command{
		...
		Short:             "[beta] Retry a failed plugin version installation",
		Example: `
  cy beta plugin registry plugin version retry my-registry my-plugin 7
`,
		RunE: retryVersion,
	}
}
...
func retryVersion(cmd *cobra.Command, args []string) error {
	...
	return printer.SmartPrint(p, nil, err, "unable to retry plugin version install", printer.Options{}, cmd.OutOrStdout())
}
