...
func (m *middleware) ListCatalogRepositories(org string) ([]*models.ServiceCatalogSource, error) {
	...
	resp, err := m.api.OrganizationServiceCatalogSources.GetServiceCatalogSources(params, root.ClientCredentials())
	if err != nil {
		return nil, err
	}
...
func (m *middleware) GetCatalogRepository(org string, catalogRepo uint32) (*models.ServiceCatalogSource, error) {
	...
	resp, err := m.api.OrganizationServiceCatalogSources.GetServiceCatalogSource(params, root.ClientCredentials())
	if err != nil {
		return nil, err
	}
...
func (m *middleware) DeleteCatalogRepository(org string, catalogRepo uint32) error {
	...
	_, err := m.api.OrganizationServiceCatalogSources.DeleteServiceCatalogSource(params, root.ClientCredentials())
	return err
}
...
func (m *middleware) CreateCatalogRepository(org, name, url, branch string, cred uint32) (*models.ServiceCatalogSource, error) {
	...
	resp, err := m.api.OrganizationServiceCatalogSources.CreateServiceCatalogSource(params, root.ClientCredentials())
	if err != nil {
		return nil, err
	}
...
func (m *middleware) UpdateCatalogRepository(org string, catalogRepo uint32, name, url, branch string, cred uint32) (*models.ServiceCatalogSource, error) {
	...
	resp, err := m.api.OrganizationServiceCatalogSources.UpdateServiceCatalogSource(params, root.ClientCredentials())
	if err != nil {
		return nil, err
	}
...
func (m *middleware) RefreshCatalogRepository(org string, catalogRepo uint32) (*models.ServiceCatalogSource, error) {
	...
	resp, err := m.api.OrganizationServiceCatalogSources.RefreshServiceCatalogSource(params, root.ClientCredentials())
	if err != nil {
		return nil, err
	}
