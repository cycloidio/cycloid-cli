...
func NewPluginGetCommand() *cobra.Command {
	var cmd = &cobra.Command{
		Use:   "get",
		Args:  cobra.NoArgs,
		Short: "get a plugin from a registry",
		Example: `
	# Get plugin 2 from registry 1
	cy --org my-org plugin-registry plugin get --registry-id 1 --plugin-id 2
`,
		RunE: getPlugin,
	}
...
func getPlugin(cmd *cobra.Command, args []string) error {
	...
	if err != nil {
		return printer.SmartPrint(p, nil, err, "unable to get registry plugin", printer.Options{}, cmd.OutOrStderr())
	}
