...
func NewVersionGetCommand() *cobra.Command {
	var cmd = &cobra.Command{
		Use:   "get",
		Args:  cobra.NoArgs,
		Short: "get a plugin version",
		Example: `
	# Get version 3 of plugin 2 in registry 1
	cy --org my-org plugin-registry version get --registry-id 1 --plugin-id 2 --version-id 3
`,
		RunE: getVersion,
	}
...
func getVersion(cmd *cobra.Command, args []string) error {
	...
	if err != nil {
		return printer.SmartPrint(p, nil, err, "unable to get plugin version", printer.Options{}, cmd.OutOrStderr())
	}
