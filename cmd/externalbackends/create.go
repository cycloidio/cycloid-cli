...
func newInfraViewCommand() *cobra.Command {
	...
	// AWSRemoteTFState
	aWSRemoteTFState := &cobra.Command{
	...
	gCPRemoteTFState := &cobra.Command{
	...
	swiftRemoteTFState := &cobra.Command{
...
func newEventsCommand() *cobra.Command {
	...
	// Aws CW logs
	eventsAWSCloudWatchLogsCmd := &cobra.Command{
...
func newLogsCommand() *cobra.Command {
	...
	// Aws CW logs
	logsAWSCloudWatchLogsCmd := &cobra.Command{
		Use:  "AWSCloudWatchLogs",
		RunE: createLogs,
	}
	...
	// Elasticsearch
	logsElasticsearchLogsCmd := &cobra.Command{
