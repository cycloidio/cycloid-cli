...
type AuthenticationConfig interface {
	...
	// Whether this authentication is not owned by the queried organization but
	// resolved from the nearest ancestor organization that has it configured.
	// Read-only; only ever set by the organization authentications list/get
	// endpoints for a child organization without its own configuration.
	//
	// Read Only: true
	Inherited() *bool
	SetInherited(*bool)

	// Canonical of the ancestor organization that owns this configuration when
	// `inherited` is true. Empty otherwise.
	//
	// Read Only: true
...
// Inherited gets the inherited of this polymorphic type
func (m *authenticationConfig) Inherited() *bool {
	return m.inheritedField
}

// SetInherited sets the inherited of this polymorphic type
func (m *authenticationConfig) SetInherited(val *bool) {
	m.inheritedField = val
}

// InheritedFrom gets the inherited from of this polymorphic type
func (m *authenticationConfig) InheritedFrom() string {
	return m.inheritedFromField
}

// SetInheritedFrom sets the inherited from of this polymorphic type
func (m *authenticationConfig) SetInheritedFrom(val string) {
...
// ContextValidate validate this authentication config based on the context it is used
...
func (m *authenticationConfig) contextValidateInherited(ctx context.Context, formats strfmt.Registry) error {
...
func (m *authenticationConfig) contextValidateInheritedFrom(ctx context.Context, formats strfmt.Registry) error {
