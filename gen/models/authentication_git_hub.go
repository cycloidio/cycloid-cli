...
func (m *AuthenticationGitHub) contextValidateInherited(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AuthenticationGitHub) contextValidateInheritedFrom(ctx context.Context, formats strfmt.Registry) error {
