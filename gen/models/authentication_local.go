...
func (m *AuthenticationLocal) contextValidateInherited(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AuthenticationLocal) contextValidateInheritedFrom(ctx context.Context, formats strfmt.Registry) error {
