...
func (m *AuthenticationSAML) contextValidateInherited(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AuthenticationSAML) contextValidateInheritedFrom(ctx context.Context, formats strfmt.Registry) error {
