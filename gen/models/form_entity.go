...
type FormEntity struct {
	...
	// Whether or not the entity is displayed to the user but cannot be modified. Useful for showing computed or immutable values.
	ReadOnly bool `json:"read_only,omitempty"`

	// Whether or not the entity can be set at creation but is locked on every subsequent update. Once a value has been stored it cannot be modified anymore.
	ReadOnlyOnUpdate bool `json:"read_only_on_update,omitempty"`
...
const (
	...
	// FormEntityWidgetDateTime captures enum value "date_time"
	FormEntityWidgetDateTime string = "date_time"
