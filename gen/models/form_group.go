...
type FormGroup struct {
	...
	// An optional description to display for this group
	...
	// Whether or not the variables of the group are displayed to the user but cannot be modified. Useful for showing computed or immutable values.
	ReadOnly bool `json:"read_only,omitempty"`

	// Whether or not the variables of the group can be set at creation but are locked on every subsequent update. Once a value has been stored it cannot be modified anymore.
