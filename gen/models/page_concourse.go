...
// ContextValidate validates this page concourse based on context it is used
func (m *PageConcourse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
