...
type Plugin struct {
	...
	// True when the local install has no corresponding registry plugin
	// (e.g. the registry plugin was deleted out-of-band, or the registry is
	// unreachable). When true, Latest/Version fields may be zero-valued and
	// update operations will be rejected. Defaults to false.
	//
