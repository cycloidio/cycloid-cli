...
// ContextValidate validate this try plan based on the context it is used
func (m *TryPlan) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TryPlan) contextValidateNext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TryPlan) contextValidateStep(ctx context.Context, formats strfmt.Registry) error {
