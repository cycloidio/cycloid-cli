...
type UserOAuth struct {
	...
	// OIDC group names whose mapped team could not be applied during a partial-apply login (the team did not resolve in the login organization). The login still succeeds with the valid teams applied; the frontend surfaces these as a non-blocking banner (FE-1435). Empty or absent when every mapped team applied cleanly.
	OidcPartialFailureGroups []string `json:"oidc_partial_failure_groups"`
